...
//        //System.out.println(product3.displayInfo());
        ...
        Product chocolate1 = new Chocolate("Аленка", "Шоколад", 120, 150);
        System.out.println(chocolate1.displayInfo());
        Product chocolate2 = new Chocolate("Аленка", "Шоколад", 120, 150);
        System.out.println(chocolate2.displayInfo());
        Product chocolate3 = new Chocolate("Milka", "Шоколад", 150, 140);
        System.out.println(chocolate3.displayInfo());
        Product chocolate4 = new Chocolate("Milka", "Шоколад", 150, 140);
        System.out.println(chocolate4.displayInfo());
        Product chocolate5 = new Chocolate("Milka", "Шоколад", 150, 140);
        ...
        Chocolate chocolate = vendingMachine.getChocolate(140);
        if (chocolate == null){
